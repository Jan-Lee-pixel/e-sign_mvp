    ...
    return (
        <div className="h-screen w-screen flex flex-col overflow-hidden bg-gray-100 font-sans">
            ...
            <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shadow-sm z-30 shrink-0">
                ...
                <div className="flex items-center gap-4">
                    <div className="px-3 py-1.5 bg-gray-50 rounded-lg text-sm text-gray-700 border border-gray-200 font-medium">
                        {completedFieldsCount} / {totalFieldsCount} Signed
                    </div>
                    <Button
                        onClick={handleFinish}
                        disabled={!isComplete && completedFieldsCount < totalFieldsCount}
                        className={isComplete || completedFieldsCount >= totalFieldsCount ? "bg-green-600 hover:bg-green-700" : ""}
                        isLoading={isSaving}
                    >
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <aside className="w-80 bg-white border-r border-gray-200 flex flex-col shrink-0 overflow-y-auto">
                    <div className="p-6 border-b border-gray-100">
                        <h2 className="text-sm font-bold text-gray-900 uppercase tracking-wider">Required Fields</h2>
                        <p className="text-xs text-gray-500 mt-1">Click a field below to jump to it.</p>
                    </div>
                                    ...
                                    >
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className={`text-sm font-semibold mb-0.5 ${isSigned ? 'text-green-900' : 'text-gray-900'}`}>
                                                    Signature Field
                                                </div>
                                                <div className="text-xs text-gray-500">Page {field.page_number}</div>
                                            </div>
                                        </div>
                                    </button>
                                )
